-- Initial schema for Veterinary Clinic Management System
...
CREATE INDEX IF NOT EXISTS idx_patient_owners_patient ON patient_owners(patient_id);
CREATE INDEX IF NOT EXISTS idx_patient_owners_owner ON patient_owners(owner_id);
